...
typedef enum
{
    ...
    CAN_PIT_MOTOR_ID = 0x206,
		...
		CAN_FRONT_MOTOR_ID = 0x203,

    CAN_SHOOT_MOTOR_LEFT_ID  = 0x201,
    CAN_SHOOT_MOTOR_RIGHT_ID = 0x202,
...
extern motor_DATA_t    SHOOT_MOTOR_LEFT;
extern motor_DATA_t    SHOOT_MOTOR_RIGHT;
extern motor_DATA_t    TRRIGLE_MOTOR_RIGHT;
extern motor_DATA_t    FRONT_MOTOR;
