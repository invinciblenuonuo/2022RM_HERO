...
extern fp32 YAW,PITCH,ROLL;      //euler angle, unit rad.欧拉角 单位 rad
...
extern float YAW_CTNU,PITCH_CTNU;
...
/**
  ...
  * @retval         
  */
extern int GYRO_SIX_AXIS(void);

/**
  * @brief          不使用RTOS时 陀螺仪初始化函数
  */
extern int GYRO_SIX_AXIS_Init(void);
/**
  * @brief          使陀螺仪值连续
  */
int DATA_CONTINUE(void);
